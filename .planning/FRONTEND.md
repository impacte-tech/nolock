...
| 5 | **ChatPanel** | `src/components/ChatPanel.tsx` | 218 | Markdown rendering, tool calls display, multi-backend AI chat | `ChatPanel.test.tsx`, `MarkdownContent.test.tsx`, `ToolCallBlock.test.tsx` | ✅ |
...
| — | **Styles** | `src/styles.css` | 1132 | Full dark theme, all component styles | — | ✅ |
